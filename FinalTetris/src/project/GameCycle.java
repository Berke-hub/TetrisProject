...
public class GameCycle extends JPanel implements Runnable{
	 ...
	 public static final int empty = -1; 
	   ...
	   void addShape(Shape shape) { // adds the shape to the board
	   ...
	   void drawUI(Graphics2D g) {
	       ...
	       g.drawString(format("Ekin Çoþkun    		   %6d", scoreboard.getLevel()), namesx, namesy + 40);
	       g.drawString(format("Egehan Daþtan    	   %6d", scoreboard.getLevel()), namesx, namesy + 80);
	       g.drawString(format("Berke Koçyiðitoðlu     %6d", scoreboard.getLevel()), namesx, namesy + 120);
